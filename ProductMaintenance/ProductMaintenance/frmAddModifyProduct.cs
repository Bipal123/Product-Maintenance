    ...
    public partial class frmAddModifyProduct : Form
    {
        ...
        private void btnAccept_Click(object sender, EventArgs e)
        {
            if (IsValidData())
            {
                if (addProduct)
                {
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            MessageBox.Show("Another product with the same code already exists.", "Error!");
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                else //code that runs if we update the product
                {
                    ...
                    try
                    {
                        ...
                        {
                            this.DialogResult = DialogResult.Retry;
                            MessageBox.Show("Another user has updated or deleted the product.", "Error!");
                        }
                    }
                    catch (Exception ex)
                    {
